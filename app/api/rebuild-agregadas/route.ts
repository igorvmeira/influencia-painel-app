...
export async function GET(req: Request) {
  // Auth migrada para o helper que FALHA FECHADO. A versão original desta rota
  // (recuperada do commit aa7148c) usava `!segredo || ...`, que deixava a rota ABERTA
  // se a env sumisse. Não reintroduzir esse padrão.
